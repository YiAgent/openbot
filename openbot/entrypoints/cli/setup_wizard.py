...
Run:
    uv run python -m openbot.entrypoints.cli.setup_wizard           # interactive
    uv run python -m openbot.entrypoints.cli.setup_wizard --org YiAgent --noninteractive
...
_logger = logging.getLogger("openbot.entrypoints.cli.setup_wizard")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="openbot.entrypoints.cli.setup_wizard")
    ...
    if appends:
        if not existing:
            lines = [
                ...
                "# Generated by openbot.entrypoints.cli.setup_wizard.",
                "",
            ]
