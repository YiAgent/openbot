...
from .docker_build import BuildMode, build_instance_images
...
def filter_dataset_to_build(
    ...
    for instance in dataset:
        ...
        if force_rebuild or spec.instance_image_key not in existing_images:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["cli", "api"],
        default="api",
        help="Build using Docker REST API or Docker CLI. Try CLI if API fails due to UID/GUID error.",
    )
