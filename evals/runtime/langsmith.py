"""LangSmith trace routing, Experiment projection, and task assembly.
...
``build_export_experiment`` is the task-side assembly helper that wires
:class:`LangSmithExperiment` together with the prediction exporter
scorer used by SWE-/SWT-bench style tasks.
"""
